...
const CategorySection = () => {
    const { categoryName, setCategoryName, loading, setLoading } = useProductContext();
        ...
        <div className='w-full'>
            ...
            <div className='flex absolute w-full'>
                ...
                <div className='w-full min-h-screen  absolute right-0 flex flex-col items-center justify-center gap-8 md:w-4/5'>
                    <h1 className='text-4xl font-semibold'>Create product category </h1>
                    <input onChange={(e) => {
                        setCategoryName(e.target.value)
                    }} type="text" placeholder="Category Name" className='w-4/5 h-10 rounded-md border border-gray-400 outline-gray-400 hover:outline-rose-500 pl-4 text-xl' />
